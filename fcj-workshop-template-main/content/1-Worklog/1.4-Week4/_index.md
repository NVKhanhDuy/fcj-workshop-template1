...
* Review advanced networking connectivity models on AWS through VPC Peering and AWS Transit Gateway.
...
* Gain a clear understanding of automated application deployment workflows with CI/CD Pipelines utilizing GitLab, GitHub Actions, AWS CodeBuild, AWS CodeDeploy, and AWS CodePipeline.
* Become familiar with data storage and analytics services on AWS such as File Storage Gateway, Amazon FSx for Windows File Server, and Data Lakes.
