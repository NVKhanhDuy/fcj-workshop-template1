...
* Review cost optimization, resource management, and access control solutions on AWS using Amazon Lightsail, Tags, Resource Groups, and IAM Policies based on Resource Tags.
* Gain a clear understanding of how to automatically scale applications, load balance, and monitor systems using Amazon EC2 Auto Scaling, Elastic Load Balancing, Amazon CloudWatch, and Grafana.
* Become familiar with operations and automation tools on AWS such as AWS CLI, AWS Lambda, CloudWatch Dashboards, and Slack notification integration.
* Review hybrid DNS connectivity models, virtual machine migration, and database migration using Route 53 Resolver, VM Import/Export, AWS DMS, and AWS Schema Conversion Tool.
