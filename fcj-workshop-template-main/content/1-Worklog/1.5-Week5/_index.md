...
* Review methodologies for server right-sizing, cost visualization, and advanced cost analysis on AWS.
* Gain a clear understanding of the process of decomposing and migrating the Monolith TravelBuddy application into a Microservices architecture using Elastic Beanstalk, CodeStar, CodePipeline, Lambda, and API Gateway.
...
* Become familiar with building a Single Page Application (SPA) secured by Amazon Cognito authentication and gain hands-on experience with AWS AI services including Amazon Polly, Amazon Rekognition, and Amazon Lex.
